...
let  allDutiesContentCheck  = function(assert : Assert) {
    ...
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Pebbles');

    rowSelector = rowSelector + " ~ .duty-row-wrapper "
    assert.dom(rowSelector + ".duty-row").exists();
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-type','Communion');
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','Downstairs');
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-icon','unconfirmed');
    ...
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','Downstairs');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Betty, Pearl');

    rowSelector = rowSelector + " ~ .duty-row-wrapper "
    assert.dom(rowSelector + ".duty-row").exists();
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-type','Communion');
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','Upstairs');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Fred');
    ...
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Barney');
    ...
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Pearl');

    rowSelector = rowSelector + " ~ .duty-row-wrapper "
    assert.dom(rowSelector + ".duty-row").exists();
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-type','Baptism');
    assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
    assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Sam, Tex');
...
module('Application | Content', function(hooks) {
    ...
    test ('Family Duties content - Fred', async function(assert) {
        ...
        assert.dom(rowSelector + ".duty-row").hasAttribute('data-test-subtype','');
        assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-icon','unconfirmed');
        assert.dom(rowSelector + '.duty-row').hasAttribute('data-test-names','Tex');
